...
import logo from "../assets/rainhoePopcorn.png";
                  ...
                  <>
                    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                      <Box sx={{ display: "flex", alignItems: "center" }}>
                        ...
                        <TextField
                          key={submission.id}
                          type="text"
                          sx={{ width: `${submission.id.length * 84}px`, fontWeight: "550", fontSize: "1.25rem" }}
                      ...
                      <Box sx={{ display: "flex", alignItems: "center" }}>
                        <TextField
                          key={currentIndex}
                          type="text"
                          sx={{ width: `${submissions.length.toString().length * 48}px`, fontWeight: "550", fontSize: "1.25rem", mr: 1 }}
                          inputProps={{ sx: { textAlign: "center" } }}
                          autoCapitalize="off"
                          autoCorrect="off"
                          autoComplete="off"
                    ...
                    <Box sx={{ display: "flex", width: "100%", justifyContent: "center", alignItems: "center", flexDirection: isMobile ? "column" : "row" }}>
                      ...
                      {contest.type === "emote" && (submission.video?.source === "7tv" || !submission.video.source) && (
                        <Box sx={{ height: "100%", width: isMobile ? "100%" : "60%", display: "flex", justifyContent: "center" }}>
