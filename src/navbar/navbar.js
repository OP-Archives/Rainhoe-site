...
import { AppBar, Toolbar, Typography, useMediaQuery, Box, Divider, SvgIcon } from "@mui/material";
import Logo from "../assets/rainhoeRave.gif";
...
const socials = [
  {
    path: `https://twitter.com/RainhoeVT`,
    icon: <TwitterIcon color="primary" />,
  },
  {
    path: `https://www.youtube.com/channel/UCy3Agg3SmkAS_i_B2qpdaww`,
  ...
  {
    path: `https://www.tiktok.com/@rainhoevt`,
    icon: (
        ...
        <Toolbar>
          ...
          {!isMobile && (
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", flex: 1 }}>
              ...
              <Box sx={{ mr: 2 }}>
                <CustomLink href="https://uwumarket.us/collections/rainhoe" rel="noopener noreferrer" target="_blank">
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
